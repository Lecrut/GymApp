    ...
    <v-row class="my-auto">
      <v-col class="d-flex justify-center " cols="12" md="6">
        <v-card color="secondary" class="pa-6 w-100 mx-auto" style="max-width: 700px; width: 100%;">
          <v-card-title class="text-h5 mb-4 text-center">{{ $t('auth.register.register').toUpperCase() }}</v-card-title>
          <v-btn
            color="primary"
            class="my-4"
            block
          ...
          {{ $t('auth.register.google') }}
            ...
            <template v-slot:item.3>
              <v-stepper-content step="3">
                <v-card-title class="text-h5 mb-4 text-center ">{{ steps[2].text }}</v-card-title>
                <v-form class="mx-auto" style="max-width: 400px; width: 100%;">
                  <v-text-field
